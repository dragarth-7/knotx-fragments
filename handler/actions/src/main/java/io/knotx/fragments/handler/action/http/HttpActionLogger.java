...
public class HttpActionLogger {
  ...
  private HttpActionLogger(ActionLogger actionLogger) {
    this.actionLogger = actionLogger;
  }

  HttpActionLogger create(String actionAlias, ActionLogLevel logLevel) {
    return new HttpActionLogger(ActionLogger.create(actionAlias, logLevel));
  }
